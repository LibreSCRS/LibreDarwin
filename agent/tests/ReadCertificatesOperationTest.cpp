...
// session or running the cert reader; a cold read populates it.
...
// COLD read reaches the fake reader and succeeds.
...
TEST(ReadCertificatesOperation, CacheHitSkipsFlowAndEmitsCertificates)
{
    ...
    ReadCertificatesOperation op(std::move(channel),
